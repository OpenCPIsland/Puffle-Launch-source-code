...
public class UIVirtualScreen : MonoBehaviour, IEZDragDrop, IUIObject
{
	...
	protected void InputProcessor(ref POINTER_INFO ptr)
	{
		...
		{
			vector = new Vector3(hitInfo.textureCoord.x * screenCamera.pixelWidth, hitInfo.textureCoord.y * screenCamera.pixelHeight);
	...
	public IUIObject GetControl(ref POINTER_INFO ptr)
	{
		...
		{
			iUIObject = hitInfo.collider.gameObject.GetComponent(typeof(IUIObject)) as IUIObject;
		}
