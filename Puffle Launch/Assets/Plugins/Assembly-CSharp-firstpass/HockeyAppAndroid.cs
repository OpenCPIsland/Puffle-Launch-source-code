...
public class HockeyAppAndroid : MonoBehaviour
{
	...
	private bool CanUseAndroidPlugin()
	{
	...
	private void Awake()
	{
		...
		Debug.LogError("Calling StartCrashManager");
	...
	protected void StartCrashManager(string urlString, string appID, bool updateManagerEnabled, bool autoSendEnabled)
	{
		...
		try
		{
			...
			Debug.LogError("Calling native startHockeyAppManager");
			androidJavaClass2.CallStatic("startHockeyAppManager", androidJavaObject, urlString, appID, updateManagerEnabled, autoSendEnabled);
		}
		catch
		{
			Debug.LogWarning("HockeyAppAndroid: native crash manager unavailable.");
		}
	}
